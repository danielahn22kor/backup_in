...
<table class="table">
	...
	<tr>
		...
		<td><a href="view.php?text_idx=<?php echo $row['text_idx']; ?>&title=<?php echo $row['title']; ?>&cont_path=<?php echo $cont_path; ?>&endDay=<?php echo $end_Day; ?>" ><?php echo $row['title']?></a></td>
...
<?php
	...
	if(1<$now_block ) {
	  ...
	  echo '<a href="contents.php?total='.$total.'&cont_path'.$cont_path.'&txt_path='.$txt_path.'&page='.$pre_page.'&endDay='.$end_Day.'">다음</a>';
...
?>
	...
	<?php for($i=$start_page;$i<=$end_page;$i++) :?>
	    <li><a href="contents.php?total=<?php echo $total; ?>&cont_path=<?php echo $cont_path; ?>&txt_path=<?php echo $txt_path; ?>&page=<?php echo $i; ?>&endDay=<?php echo $end_Day;?>"><?php echo $i; ?></a></li>
	<?php endfor?>
	</ul>
	<?php
	if($now_block < $total_block) 
	{
	  ...
	  echo '<a href="contents.php?total='.$total.'&cont_path'.$cont_path.'&txt_path='.$txt_path.'&page='.$post_page.'&endDay='.$end_Day.'">다음</a>';
	}
