...
$q = "SELECT * FROM danAhnDB.아이폰5s_text_Information WHERE 1 ORDER BY text_idx LIMIT ".$start_record.", ".$record_to_get."";
...
<table class="table">
	...
	<tr>
		...
		<td><a href="view.php?text_idx=<?php echo $row['text_idx']; ?>&title=<?php echo $row['title']; ?>" ><?php echo $row['title']?></a></td>
...
<?php
	...
	if(1<$now_block ) {
	  ...
	  echo '<a href=contents.php?total='.$total.'&page='.$pre_page.'">이전</a>';
...
?>
	...
	<?php for($i=$start_page;$i<=$end_page;$i++) :?>
	    <li><a href="contents.php?total=<?php echo $total; ?>&page=<?php echo $i; ?>" class = "btn"><?php echo $i; ?></a></li>
	<?php endfor?>
	</ul>
	<?php
	if($now_block < $total_block) 
	{
	  ...
	  echo '<a href="contents.php?total='.$total.'&page='.$post_page.'">다음</a>';
	}
